...
public class AlterarValorComercialMensalidadeRequest
{
    ...
    public AlterarValorComercialMensalidadeRequest(Entities.ValorComercialMensalidade valorComercialMensalidade)
    {
        Id = valorComercialMensalidade.Id;
